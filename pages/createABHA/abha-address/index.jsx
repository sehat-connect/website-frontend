        ...
        <div className=" flex flex-wrap">
          ...
          <div className="w-full grid sm:grid-cols-2 grid-cols-1 overflow-hidden">
            ...
            <div className=" bg-[#fff]  rounded-e-xl grid place-content-center sm:px-[120px] px-4">
                <h4 className="sm:text-[34px] text-[24px] font-medium text-center text-black">Create ABHA Address</h4>
               
                <Link href="/createABHA/abha-address/create/abha-number" className="border-2 flex rounded-lg items-center p-6 mt-8  gap-x-10">
                    <Image src="/images/aadhar_icon.png" width={60} height={50} className="relative object-contain m-auto " alt="" />
                    <div className="">
                        <h3 className=" text-[16px] font-bold  text-[#272727]">Using ABHA Number</h3>
                ...
                <Link href="/createABHA/abha-address/create/mobile"  className="border-2 flex rounded-lg items-center p-6 mt-4 gap-x-10">
