...
export default function Index() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setSubmitting, resetForm }) => {
            const res = await fetch(
                `${process.env.webUrl}/api/abdm/CreatePhrWithMobile/VerifyOtp`,
                {
                    method: "POST",
                    body: JSON.stringify({
            ...
            if (res.status === 200) {
                ...
                console.log(data)
                if(data.mappedPhrAddress.length > 0 ){
                    router.push({
                    ...
                    router.push({
                        pathname: '/createABHA/abha-address/create/mobile/registration',
                        query: {
                            transactionId: data.transactionId
                        },
                    },
                    ...
                    <div className="w-full grid grid-cols-2 overflow-hidden">
                        ...
                        <div className=" bg-[#fff] rounded-e-xl grid place-content-center px-[120px]">
                            <h4 className="text-[28px] font-medium text-left text-black">
                                Verify OTP sent to your mobile number {params.mobileNumber}
                            </h4>
